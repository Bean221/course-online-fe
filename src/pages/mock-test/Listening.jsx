...
const TestCard = ({ month, testsTaken, year }) => {
  ...
  const handleClick = () => {
    navigate(`/test/listening/${year}/${month}`);
  };

  return (
    <button
      onClick={handleClick}
      className="w-full border border-red-300 rounded-lg p-5 shadow-sm bg-white
      ...
      <div className="flex items-center mb-6">
        {image && (
          <img
            src={image}
            alt={`Cover ${year}`}
            className="w-20 h-20 object-cover rounded-full mr-6 border-4 border-red-400"
          />
        )}
        <h2 className="text-3xl font-bold text-gray-900">
          IELTS Listening Test {year}
        </h2>
      </div>
...
const ListeningTest = () => {
  ...
  const [listeningTestsData] = useState([
    {
      year: 2025,
      image: thithuImage,
      months: [
        { month: "January", testsTaken: "980,000" },
        { month: "February", testsTaken: "875,000" },
        { month: "March", testsTaken: "690,000" },
      ],
    },
    {
      year: 2024,
      image: thithuImage,
      months: [
        { month: "January", testsTaken: "856,341" },
        { month: "February", testsTaken: "967,230" },
        { month: "March", testsTaken: "765,112" },
        { month: "April", testsTaken: "543,287" },
        { month: "May", testsTaken: "621,934" },
        { month: "June", testsTaken: "904,125" },
        { month: "July", testsTaken: "723,456" },
        { month: "August", testsTaken: "510,230" },
        { month: "September", testsTaken: "342,118" },
      ],
    },
    {
      year: 2023,
      image: thithuImage,
      months: [
        { month: "January", testsTaken: "812,567" },
        { month: "February", testsTaken: "756,124" },
        { month: "March", testsTaken: "689,452" },
        { month: "April", testsTaken: "567,891" },
        { month: "May", testsTaken: "634,287" },
        { month: "June", testsTaken: "812,456" },
        { month: "July", testsTaken: "534,218" },
        { month: "August", testsTaken: "421,567" },
        { month: "September", testsTaken: "367,124" },
      ],
    },
    {
      year: 2022,
      image: thithuImage,
      months: [
        { month: "March", testsTaken: "654,782" },
        { month: "April", testsTaken: "598,341" },
        { month: "May", testsTaken: "687,124" },
        { month: "June", testsTaken: "734,567" },
        { month: "July", testsTaken: "512,345" },
        { month: "August", testsTaken: "456,789" },
        { month: "November", testsTaken: "321,456" },
        { month: "December", testsTaken: "287,654" },
      ],
    },
    {
      year: 2021,
      image: thithuImage,
      months: [
        { month: "April", testsTaken: "745,321" },
        { month: "May", testsTaken: "685,467" },
        { month: "June", testsTaken: "820,123" },
      ],
    },
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 pt-24 pb-10">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {/* Nội dung các năm */}
          {listeningTestsData.length === 0 ? (
            <p className="text-center text-gray-600">Loading...</p>
          ) : (
            listeningTestsData.map((testYear) => (
